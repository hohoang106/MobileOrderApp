...
public class BillDetailManagementAdapter extends BaseAdapter {
    private final Context context;
    private final int layout;
    private final List<FoodModel> lstFoods;

    public BillDetailManagementAdapter(Context context, int layout, List<FoodModel> lstFoods) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        try {
            ...
            viewHolders.btnDelete.setVisibility(View.GONE);
            return view;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
