                ...
                users.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        try {
                            ...
                            Toast.makeText(UpdateProfileUserActivity.this, "Update profile user successful!", Toast.LENGTH_LONG).show();

                            Intent mIntent = new Intent(UpdateProfileUserActivity.this, UserMenuActivity.class);
                    ...
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(UpdateProfileUserActivity.this, "Error, please call admin", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
